...
این فیچر به تکنسینان امکان می‌دهد گزارش‌های تخلف ثبت شده توسط ادمین را مشاهده کنند و در صورت امکان به آن‌ها پاسخ دهند.
...
- ✅ نمایش پاسخ قبلی تکنسین (در صورت وجود)
