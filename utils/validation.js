 ...
 */
export const validateTechnicianRegistration = (formData, step = 'personal') => {
  const errors = {};
  ...
  const requiredFields = [
    ...
    { key: 'education_field', name: 'رشته تحصیلی' },
    { key: 'telephone', name: 'تلفن ثابت' },
    { key: 'phone', name: 'شماره تلفن موبایل' },
  ...
  if (step == 'computer' && (!formData.expertise_ids || !Array.isArray(formData.expertise_ids) || formData.expertise_ids.length === 0)) {
