...
export default function ManpowerRequestsListScreen({ navigation }) {
  ...
  const handleViewDetails = async (item) => {
    try {
      ...
      const response = await getManpowerRequestById(item.id);
  ...
  const renderDetailModal = () => {
    ...
    return (
      ...
      >
        <SafeAreaView style={styles.modalOverlay} edges={{ top: 'additive', bottom: 'additive' }} style={styles.modalOverlay}>
